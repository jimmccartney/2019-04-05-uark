...
address: "Room 23"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
latlng: "FIXME"       # decimal latitude and longitude of workshop venue (e.g., "36.062584,-94.157433" - use https://www.latlong.net/)
...
instructor: ["James Teacher", "Bob Jones"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Ralph Helper"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
